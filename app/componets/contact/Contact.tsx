...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="text-base md:text-xl lg:text-2xl min-h-screen flex items-center justify-center px-6 md:px-12 bg-gradient-to-br from-[#748D92] to-[#D3D9D4] text-white overflow-hidden w-full"
    >
