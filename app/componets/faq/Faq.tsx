...
export default function FaqSection() {
  ...
  return (
    <section
      id="faq"
      className=" text-base md:text-xl lg:text-2xl min-h-screen flex flex-col justify-center py-20 px-6 md:px-12 bg-gradient-to-br from-[#748D92] to-[#D3D9D4] text-white"
    >
